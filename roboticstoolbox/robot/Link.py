...
class BaseLink(SceneNode, ABC):
    ...
    @overload
    def copy(self: "Link") -> "Link": ...  # pragma: nocover

    @overload
    def copy(self: "Link2") -> "Link2": ...  # pragma: nocover
    ...
    def _format_param(self, l, name, symbol=None, ignorevalue=None, indices=None):  # noqa  # pragma nocover
